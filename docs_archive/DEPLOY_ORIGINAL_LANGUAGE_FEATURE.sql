-- =================================================================
-- ORIGINAL LANGUAGE SELECTOR FEATURE - DATABASE UPDATE
-- Adds support for users to select their card's original language
-- =================================================================

-- Update create_card() to accept original_language parameter
...
-- Update update_card() to accept original_language parameter  
