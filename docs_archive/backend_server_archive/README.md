# CardStudio Backend API

Express.js backend server for CardStudio, handling translations, payments, AI features, and webhooks. Includes OpenAI Realtime API relay for WebRTC connections.
