...
- Include brief instructions ("Scan to learn more")
- Avoid reflective surfaces behind the code

### Size Guidelines

| Use Case | Minimum Size |
|----------|-------------|
| Table card | 2.5 x 2.5 cm |
| Wall plaque | 5 x 5 cm |
| Large signage | 10 x 10 cm |
| Outdoor display | 15 x 15 cm |

### Testing

Always test your QR codes before deployment:

1. Print a sample at intended size
...
| Plan | Monthly Budget | Sessions |
|------|----------------|----------|
| Free | Fixed | 50/month |
| Starter | $40 | ~800-1,600 |
