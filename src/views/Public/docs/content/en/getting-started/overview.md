...
| Feature | Description |
|---------|-------------|
| 🎤 **AI Voice Assistant** | Dual-level AI assistants (project & item) with voice and text chat |
| 🌐 **Auto Translation** | One-click translation to 10 languages (paid plans) |
| 📱 **QR Code Access** | Instant access via QR scan - no app required |
| 📊 **Usage Analytics** | Track sessions, popular content, and budget usage |
...
|------|-------|----------|----------|--------------|
| **Free** | $0/mo | 3 | 50/month | None |
| **Starter** | $40/mo | 5 | ~800-1,600 | 2 languages |
| **Premium** | $280/mo | 35 | ~7,000-14,000 | Unlimited |

### Content Display Modes

Choose from 4 display modes to best showcase your content:

| Mode | Best For |
|------|----------|
| **Single** | Featured items, announcements |
| **List** | Menus, directories, resources |
| **Grid** | Galleries, visual collections |
| **Cards** | Featured content, news, portfolios |

Plus optional **content grouping** to organize items into categories.
