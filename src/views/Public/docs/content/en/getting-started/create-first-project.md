...
Click the "New Project" button in the top right corner of your projects page. You can also start from a template for faster setup.

![Create Project Button](/Image/docs/create-project-button.png "Create Project")
...
Click "Create Project" to save. You'll be redirected to the project editor where you can start adding content.

:::tip Quick Preview
Use the Preview button to see how your project will look to visitors before publishing!
:::
...
Build a custom project with full control:
