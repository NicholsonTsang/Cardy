...
Welcome to the ExperienceQR developer documentation. This folder contains technical guides for developers working on the codebase.
...
These documents are maintained elsewhere in the repository:
...
| Client-Side Procedures | [/sql/storeproc/client-side/README.md](/sql/storeproc/client-side/README.md) | Frontend-accessible stored procedures |
| Server-Side Procedures | [/sql/storeproc/server-side/README.md](/sql/storeproc/server-side/README.md) | Backend-only stored procedures |
