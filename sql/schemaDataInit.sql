...
BEGIN
-- Card 1
INSERT INTO cards (id, user_id, name, description, content_render_mode, qr_code_position, image_urls, conversation_ai_enabled, ai_prompt)
VALUES (
    card1_id,
    target_user_id,
    ...
    'BR',
    ARRAY['https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=600&q=80'],
    true,
...
-- Card 1: First-layer content items
INSERT INTO content_items (id, card_id, parent_id, name, content, image_urls, ai_metadata, sort_order) VALUES
(c1_item1_id, card1_id, NULL, 'Egyptian Mysteries',
 ...
 ARRAY['https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=600&q=80'],
...
(c1_item2_id, card1_id, NULL, 'Lost Cities of Mesopotamia',
 ...
 ARRAY['https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=600&q=80'],
...
(c1_item3_id, card1_id, NULL, 'Dynasties of the Far East',
 ...
 ARRAY['https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=600&q=80'],
...
(c1_item1_child1_id, card1_id, c1_item1_id, 'The Great Pyramid of Giza',
 ...
 ARRAY['https://images.unsplash.com/photo-1502086223501-7ea6ecd79368?auto=format&fit=crop&w=600&q=80'],
...
(c1_item1_child2_id, card1_id, c1_item1_id, 'Mummification and the Afterlife',
 ...
 ARRAY['https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=600&q=80'],
...
(c1_item1_child3_id, card1_id, c1_item1_id, 'Hieroglyphics: The Language of the Gods',
 ...
 ARRAY['https://images.unsplash.com/photo-1465101178521-c1a9136a3fd8?auto=format&fit=crop&w=600&q=80'],
...
VALUES (
    ...
    'SINGLE_SERIES_MULTI_ITEMS',
    'BR',
    ARRAY['https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80'],
    true,
...
(c2_item1_id, card2_id, NULL, 'Majestic Mountains',
 ...
 ARRAY['https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=600&q=80'],
...
(c2_item2_id, card2_id, NULL, 'Rainforests: Lungs of the Earth',
 ...
 ARRAY['https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=600&q=80'],
...
SET image_urls = ARRAY['https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80']
